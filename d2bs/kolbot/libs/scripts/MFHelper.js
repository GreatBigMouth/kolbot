...
const MFHelper = new Runnable(
  function MFHelper () {
    ...
    */
    ...
    const taskList = [];
    const tasks = ["kill", "clearlevel", "clear", "clearghosts", "quit", "cows", "council", "goto", "nextup"];
          ...
          default:
            ...
            */
            ...
            if (me.area !== area) {
              ...
              String.isEqual(task, "clearghosts")
                ? (area = split)
                : (player.area !== area && !player.inTown) && (area = player.area);
            ...
            case "clear":
              ...
              break;
            case "clearghosts":
              console.log("ÿc4MFHelperÿc0: Clear ghosts in " + split);
              try {

                // Taken directly from GhostBusters script
                ...
                if (me.area !== split) {
                  ...
                  Town.move("portalspot");
                  if (!Misc.poll(() => Pather.usePortal(split, player.name), Time.seconds(15), 500 + me.ping)) {
                    throw new Error("Failed to move to clearghosts area");
                  }
                }
                clearGhosts();

              } catch (killererror3) {
                console.error(killererror3);
              }
